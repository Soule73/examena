                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-lg font-medium text-gray-900">
                            {{ $exam->questions_count ?? $exam->questions->count() }}</dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-lg font-medium text-gray-900">{{ $exam->duration }} min</dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-lg font-medium text-gray-900">
                            @if (isset($exam->answers_count))
                                {{ $exam->unique_participants_count }}
                            @else
                                {{ $exam->answers()->distinct('user_id')->count('user_id') }}
                            @endif
                        </dd>
                    </dl>
                </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-lg font-medium {{ $exam->is_active ? 'text-green-600' : 'text-red-600' }}">
